 ...
 */
    ...
    void DaisyPatchSM::Init()
    {
        ...
        led3.mode    = DSY_GPIO_MODE_OUTPUT_PP;
        led3.pull = DSY_GPIO_NOPULL;
        led3.pin  = D9;
        dsy_gpio_init(&led3);

        led4.mode    = DSY_GPIO_MODE_OUTPUT_PP;
        led4.pull = DSY_GPIO_NOPULL;
        led4.pin  = A2;
        dsy_gpio_init(&led4);

        led5.mode    = DSY_GPIO_MODE_OUTPUT_PP;
        led5.pull = DSY_GPIO_NOPULL;
        led5.pin  = A3;
        dsy_gpio_init(&led5);
